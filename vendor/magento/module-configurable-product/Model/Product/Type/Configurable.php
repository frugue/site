    ...
    private function loadUsedProducts(\Magento\Catalog\Model\Product $product, $cacheKey, $salableOnly = false)
    {
        ...
        if (!$product->hasData($dataFieldName)) {
            ...
            if ($usedProducts === null) {
				 ...
				 * The original code returns only in-stock products:
				 ...
				 * @see \Magento\ConfigurableProduct\Plugin\Model\ResourceModel\Attribute\InStockOptionSelectBuilder::afterGetSelect()
				 */
