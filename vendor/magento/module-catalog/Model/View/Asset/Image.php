...
class Image implements LocalInterface
{
    ...
    public function getUrl()
    {
		 ...
		 */
        return $this->context->getBaseUrl() . '/' . str_replace(DIRECTORY_SEPARATOR, '/', $this->getImageInfo());
    }
    ...
    {
    	/*if ('/6/3/637-ii-1.jpg' === $this->filePath) {
    		xdebug_break();
		} */
    ...
    private function getImageInfo()
    {
		 ...
		 * 		$path =
		 * 			$this->getModule() . DIRECTORY_SEPARATOR . $this->getMiscPath()
		 * 			. DIRECTORY_SEPARATOR . $this->getFilePath()
		 * 		;
		 */
        $path = $this->getModule() . DIRECTORY_SEPARATOR . $this->getMiscPath() . $this->getFilePath();
    ...
    private function convertToReadableFormat($miscParams)
    {
        ...
        $miscParams['keep_frame'] = (isset($miscParams['keep_frame']) && $miscParams['keep_frame'] ? '' : 'no') . 'frame';
        /*if ('frame' === $miscParams['keep_frame']) {
        	xdebug_break();
		} */
