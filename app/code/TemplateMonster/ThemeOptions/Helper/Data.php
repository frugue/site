...
class Data extends AbstractHelper
{
    ...
    public function getCategoryThumbWidth($viewType)
    {
		 ...
		 * 2) I have fixed the issue:
		 * «Argument 1 passed to Magento\Catalog\Block\Product\ImageFactory::getRatio()
    ...
    public function getCategoryThumbHeight($viewType)
    {
		 ...
		 * 1) «Upgrade Magento 2 from 2.1.9 to 2.3.0»: https://www.upwork.com/ab/f/contracts/21810726
		 * 2) I have fixed the issue:
		 * «Argument 2 passed to Magento\Catalog\Block\Product\ImageFactory::getRatio()
		 * must be of the type integer, string given».
		 */
        return (int)$this->scopeConfig->getValue(
