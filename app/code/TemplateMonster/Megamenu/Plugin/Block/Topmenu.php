...
class Topmenu extends TopmenuPlugin
{
    ...
    public function __construct(
		 ...
		 * 2) I have fixed the error: «Argument 2 passed to Magento\Catalog\Plugin\Block\Topmenu::__construct()
		 * must be an instance of Magento\Catalog\Model\ResourceModel\Category\StateDependentCollectionFactory,
		 * instance of Magento\Catalog\Model\ResourceModel\Category\CollectionFactory given».
