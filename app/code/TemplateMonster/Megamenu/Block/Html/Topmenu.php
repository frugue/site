...
class Topmenu extends \Magento\Theme\Block\Html\Topmenu
{
    ...
    protected function _getHtml(
        ...
        $limit,
		/**
		 * 2019-03-24 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
		 * 1) «Upgrade Magento 2 from 2.1.9 to 2.3.0»: https://www.upwork.com/ab/f/contracts/21810726
		 * 2) "Warning: Declaration of
		 * TemplateMonster\Megamenu\Block\Html\Topmenu::_getHtml()
		 * should be compatible with Magento\Theme\Block\Html\Topmenu::_getHtml()»
		 */
        array $colBrakes = []
    ) {
