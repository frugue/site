...
class MagicScrollModuleCoreClass extends \stdClass
{
    ...
    public function getHeadersTemplate($jsPath = '', $cssPath = null, $linkModuleCss = true)
    {
        ...
        $headers = [];
        // add module version
        $headers[] = '<!-- Magic Zoom Plus Magento 2 module version v1.5.30 [v1.6.71:v5.2.5] -->';
    ...
    public function loadDefaults()
    {
        $params = [
            ...
            "magicscroll"=>["id"=>"magicscroll","group"=>"General","order"=>"22","default"=>"No","label"=>"Scroll thumbnails","description"=>"","type"=>"array","subType"=>"select","values"=>["Yes","No"],"scope"=>"module"],
